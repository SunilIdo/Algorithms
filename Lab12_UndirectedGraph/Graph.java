...
public class Graph {
	...
	private void loadMajorStructures() {
		...
		//computes ConnectedComponents
		ConnectedComponentSearch ccs = new ConnectedComponentSearch(this);
		connectedComponents = ccs.getConnectedComponents();
		OddCycle oddCycle=new OddCycle(this);
		if(!oddCycle.hasOddCycle()){
			isBipartite=true;
		}
	...
	public boolean isConnected() {
		// implement
		List<Graph> connectedComponents = getConnectedComponents();
